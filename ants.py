    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.container == True and self.ant.ant == None and not insect.container:
                    self.ant.contain_ant(insect)
                elif insect.container == True and insect.ant == None and not self.ant.container:
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        return self.place.ant is not None and self.place.ant.blocks_path is not False
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while index < self.min_range:
            currentplace = currentplace.entrance
            index +=1
        
        while self.min_range <= index <= self.max_range and currentplace != hive:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            [Insect.reduce_armor(bee,self.damage) for bee in place_bees[:]]
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting == 0 and self.place.bees != []:
            chosen_bee = random_or_none(self.place.bees)
            Insect.reduce_armor(chosen_bee,chosen_bee.armor)
...
# END Problem 13
    ...
    def __init__(self):
        ...
        QueenAnt.count += 1
        self.queencount = QueenAnt.count
        # END Problem 13
    ...
    def action(self, colony):
        ...
        def double_damage(place):
            if type(place.ant) is not QueenAnt:
                if currentplace.ant:
                    if currentplace.ant.buffed == False:
                        currentplace.ant.damage *= 2 
                        currentplace.ant.buffed = True                   
                    if currentplace.ant.container and currentplace.ant.ant and not currentplace.ant.ant.buffed:
                        currentplace.ant.ant.buffed = True         
                        currentplace.ant.ant.damage *= 2            
        if self.queencount != 1:
            self.reduce_armor(self.armor)
        else:
            ScubaThrower.action(self,colony)
            while currentplace.exit:
                double_damage(currentplace)
